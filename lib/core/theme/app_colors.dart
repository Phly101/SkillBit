...
class AppColors {
  ...
  static const Color textSecondary = Color(0xFFA19C9C);
  static const Color mainGrey = Color(0xFF666666);
  static const Color mainRed = Color(0xFFF50707);
  static const Color secondaryRed = Color(0xFFA14545);
